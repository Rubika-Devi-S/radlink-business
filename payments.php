...
<div class="page-head">
    <div>
        ...
        <h1 class="mt-2">Payments</h1>
        <p>Record receipts and allocate payments to invoices.</p>
    </div>
    <button class="btn btn-brand"><i data-lucide="plus"></i> Add New</button>
</div>

<section class="card-ui p-4 text-center">
    <i data-lucide="credit-card" style="width:48px;height:48px;color:var(--brand)"></i>
    <h2 class="h5 fw-bold mt-3">Payments module</h2>
